...
PolicyLift shall conduct regular performance evaluations for employees that have been with the organization for more than a year. Respective supervisors shall perform these formal performance evaluations at least annually based on the criteria and objectives outlined in the job descriptions.

During the review the employees and their supervisor discuss relevant training needs, if any, to support in-scope systems. A review of job descriptions shall be performed and any changes shall be discussed.
