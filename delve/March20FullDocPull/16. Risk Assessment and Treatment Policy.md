...
- Review inventory of critical system assets (hardware, software, etc.)
...
- Conducting an inventory of data storage
...
- Management may periodically review the insurance needs (including cyber security insurance)
...
PolicyLift CISO or designee is responsible for overseeing the successful completion of the risk assessment.
