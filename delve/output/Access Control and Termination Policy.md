<!--
  REDLINE DOCUMENT — Access Control and Termination Policy
...
Such changes must be ~~tracked using PolicyLift ticketing or other document management tools~~ **[INSERT: documented (e.g., via ticket, message, or access log)]**.
