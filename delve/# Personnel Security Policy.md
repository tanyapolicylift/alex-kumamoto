...
This policy establishes the PolicyLift Personnel Security Policy for managing risks from personnel screening, onboarding, termination, transfer and management. The Personnel Security Policy helps the organization implement security best practices concerning personnel processes and events.

## **Scope**

The scope of this policy applies to all employees, workers and contractors (collectively referred to as “users” or “personnel” in this policy) at PolicyLift.

## **Policy**

All recruitment shall be done after careful scrutiny and examination.

All users shall have a contractual agreement with PolicyLift for not divulging any confidential or sensitive information to any unauthorized parties.
...
Roles and responsibilities shall be defined in a job description highlighting the responsibilities and required skills for specific roles and communicated to individuals. PolicyLift shall conduct periodic training and awareness programs for all users on information security responsibilities.
...
The job descriptions are reviewed and updated on an as needed basis.  The terms and conditions of employment or engagement with PolicyLift shall mandate compliance and acknowledgment of the Information Security policies by all users. This shall include a clause requiring users to protect the confidentiality of information including an intellectual property clause, code of business conduct, ethical standards, and Information Security Policy that includes appropriate use of information technology, both during and after cessation of employment or contract with PolicyLift.

All users must be aware of their security responsibilities and reporting lines by acknowledging the acceptable use agreement and through formal security awareness training.

All terms and conditions of employment shall comply with the legal requirements under the relevant jurisdiction.
...
The terms and conditions of engagement with PolicyLift shall mandate compliance with Information Security policies. In addition, contractors shall acknowledge their security responsibilities through acceptable use agreements.
...
All PolicyLift employees are required to annually acknowledge that they have read and understood the security policies and procedures. Specialized training is scheduled at intervals for different units in the organization and/or when there are significant changes to the information systems.