...
## 9. Example Template: CA Workers' Compensation
...
#### 9.1 `applicant` (one) - "Applicant & Business Info"
...
#### 9.2 `business` (one) - "Business Operations"
...
#### 9.3 `person` (many) - "Officers & Owners"
...
#### 9.4 `asset` (many) - "Locations & Class Codes"
...
#### 9.5 `loss_run` (many) - "Prior Insurance & Loss History"
...
#### 9.6 `coverage` (one) - "Coverage & Compliance"
...
#### 9.7 `operations` (one) - "Operations & Exposures"
...
### 9.8 Visual: CA Workers Comp Entity Map
...
#### 10.4 `loss_run` (many) - "Incidents & Violations"
...
#### 11.3 `loss_run` (many) - "Prior Claims"
...
### 11.5 Visual: PLRater Home Entity Map
...
## 12. Packet Lifecycle & Completeness
